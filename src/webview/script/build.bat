...
del /Q %src_dir%\dll\x64\*
del /Q %src_dir%\dll\x86\*
...
if not exist "%src_dir%\dll\x64\webview.dll" (
	...
	cl %warning_params% ^
		...
		/I "%src_dir%\include" /I "%script_dir%\microsoft.web.webview2.%nuget_version%\build\native\include" ^
...
copy /Y %src_dir%\dll\x64\*.dll %src_dir%\..\..\bin\windows\x64\
